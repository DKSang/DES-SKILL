---
name: de-persona-dataops-engineer
...
Use `de-cost-and-performance-optimization`, `de-cicd-and-testing`, or `de-project-evaluation` as the artifact skill.
