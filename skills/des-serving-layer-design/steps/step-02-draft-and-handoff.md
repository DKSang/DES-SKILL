## HALT - Serving Consumer Access

Stop here. Do not continue until the user confirms this decision.

### Why this matters
Serving exposes data to users or systems; access pattern and stability level must be approved.

### Decision needed
Choose serving path and access restrictions for each consumer.
...
### Recommended default
Choose the narrowest path that supports the consumer decision workflow.
