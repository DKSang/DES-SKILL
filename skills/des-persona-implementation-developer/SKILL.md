---
name: des-persona-implementation-developer
...
Use `des-create-epic`, `des-sprint-planning`, `des-create-story`, `des-check-implementation-readiness`, `des-implementation-planning`, or `des-dev-story` as the support skill.
