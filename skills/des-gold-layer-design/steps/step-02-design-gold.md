## HALT - Gold Table Grain and Consumer Approval

Stop here. Do not continue until the user confirms this decision.

### Why this matters
Every Gold table must have a clear business question, consumer, grain, primary key, freshness expectation, and contract level.

### Decision needed
Approve, revise, or defer each candidate Gold table.
...
### Recommended default
Approve only when the table has a consumer and the sentence 'one row per ...' is unambiguous.
