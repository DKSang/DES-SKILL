...
- Freshness and SLA requirements (`03-requirements-and-kpis.md`).
...
Next use `de-bronze-layer-design` to specify the raw landing table structure, partition design, metadata columns, and schema drift policy.
