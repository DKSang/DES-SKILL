...
- **READY TO SIGN**: "Contract sẵn sàng ký kết. Proceed với `de-data-quality`."
- **SIGN WITH ADDENDUM**: "Ký kèm addendum. Track HIGH items trong sprint. Proceed với `de-transformation-design`."
- **DO NOT SIGN**: "Cần revise contract. Chạy lại `de-data-contracts` với findings này làm input."
