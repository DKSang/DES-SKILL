## HALT - CI/CD Release Gate Approval

Stop here. Do not continue until the user confirms this decision.

### Why this matters
Deployment must not proceed without approved gates for tests, validation, secrets, smoke checks, and promotion.

### Decision needed
Approve CI/CD gates and environment promotion rules.
...
### Recommended default
Choose B when development needs speed but release evidence still matters.
