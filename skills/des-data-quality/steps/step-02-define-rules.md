## HALT - Data Quality Severity Approval

Stop here. Do not continue until the user confirms this decision.

### Why this matters
DQ severity determines whether pipelines block, warn, continue, alert, quarantine, or only record information.

### Decision needed
Classify each unresolved DQ rule and approve threshold, owner, and remediation.
...
### Recommended default
Use P1 for required keys, timestamps, contract fields, and metrics that would be materially wrong.
