---
name: de-persona-data-product-analyst
...
# de-persona-data-product-analyst
...
Use `de-business-discovery`, `de-business-questions`, `de-requirements-and-kpis`, or `de-data-product-definition` as the artifact skill.
