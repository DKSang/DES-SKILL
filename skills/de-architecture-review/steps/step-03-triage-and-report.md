...
- ≥ 3 BLOCKER → 🔴 **REJECTED** — Architecture cần revise đáng kể; quay lại `de-architecture-design`
...
Ngày review: [date]
Reviewer: DES-SKILL de-architecture-review
...
**Date**: [date]
**Reviewed by**: de-architecture-review
...
- **Verdict APPROVED hoặc CONDITIONAL**: "Review hoàn tất. Tiếp tục với `de-ingestion-design`."
- **Verdict REJECTED**: "Cần revise architecture. Chạy lại `de-architecture-design` với findings này làm input."
