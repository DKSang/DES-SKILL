---
name: des-governance-and-security
...
Next use `des-cost-and-performance-optimization` to review partitioning, compute, query performance, and platform cost before final CI/CD and release controls.
