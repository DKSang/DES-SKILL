...
- Domain model and entity grain decisions (`06-conceptual-domain-model.md`).
- Business requirements (`03-requirements-and-kpi-catalog.md`).
...
Next use `des-gold-layer-design` to model business-ready facts, dimensions, marts, and certified metrics.
