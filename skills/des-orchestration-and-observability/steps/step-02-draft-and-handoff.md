## HALT - Failure Response Ownership

Stop here. Do not continue until the user confirms this decision.

### Why this matters
A schedule or alert is not useful without owner, response time, retry behavior, escalation path, and recovery steps.

### Decision needed
Approve failure response for each pipeline or job.
...
### Recommended default
Do not choose D for P1 pipelines or consumer-facing freshness commitments.
