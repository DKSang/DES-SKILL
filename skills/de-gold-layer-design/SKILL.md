...
- KPI catalog and consumer query patterns (`03-requirements-and-kpis.md`).
- Domain model and entity definitions (`06-domain-modeling.md`).
...
Next use `de-data-contracts` to formalize producer and consumer expectations for critical Gold datasets.
