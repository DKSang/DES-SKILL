...
- KPI catalog with certified formulas (`03-requirements-and-kpi-catalog.md`).
- Data product consumer requirements (`04-data-product-specification.md`).
...
Next use `des-serving-layer-design` to configure the final consumer-facing serving assets (dashboards, APIs, exports) that query the semantic model.
