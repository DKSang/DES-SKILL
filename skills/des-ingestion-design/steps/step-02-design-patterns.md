## HALT - Ingestion Pattern and Replay Strategy

Stop here. Do not continue until the user confirms this decision.

### Why this matters
Ingestion cannot be implemented safely without idempotency, replay, rate-limit, late-data, and failure recovery decisions.

### Decision needed
Choose ingestion and replay strategy for each source.
...
### Recommended default
Choose the simplest option that satisfies freshness, replay, and source behavior.
