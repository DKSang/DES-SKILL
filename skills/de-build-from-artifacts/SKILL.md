...
Use after `de-implementation-planning` has produced an approved `implementation-plan.md` and `implementation-story.md`. Use to implement tasks while preserving artifact traceability, implementation status, evidence, and scope control.
