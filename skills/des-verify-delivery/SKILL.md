...
- If evidence does not support the completion claim, HALT and route back to `des-dev-story`.
...
Use `des-retrospective` after successful or partial delivery. Use `des-dev-story` when verification fails.
