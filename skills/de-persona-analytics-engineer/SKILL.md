---
name: de-persona-analytics-engineer
...
Use `de-semantic-model-design`, `de-serving-layer-design`, or `de-semantic-and-serving-layer` as the artifact skill.
