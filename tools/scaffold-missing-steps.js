...
const STEPS_MAP = {
  ...
  'des-gold-layer-design': {
    steps: [
      ...
      { file: 'step-03-draft-and-handoff.md', title: 'Soạn Thảo Gold Design và Bàn Giao', next: null,
        content: `### 1. Nạp template\nĐọc: 11-gold-layer-design-template.md\n\n### 2. Soạn thảo artifact\nFact + Dimension tables với schema, grain, measures, FK/SK mapping.\n\n### 3. Ghi file và cập nhật trạng thái\nLưu vào 11-gold-layer-design.md. Update workflow status.\n\n### 4. Menu bàn giao\n- **[C] Hoàn thành**: Gợi ý \`des-data-contracts\`.\n- **[R] Soạn lại**: Quay lại step-01.` }
    ]
  },
  'des-data-contracts': {
    steps: [
      { file: 'step-01-context-and-readiness.md', title: 'Context and Readiness', next: 'step-02-contract-boundary-and-obligations.md',
        content: `### 1. Nạp artifact đầu vào\nĐọc: Data products (04), Gold design (11), Source assessment (05).\n\n### 2. Xác định contract scope\nContract cần thiết khi: cross-team dependency, SLA commitment, downstream consumers không control được source.\n\n### 3. HALT - Readiness Check Failed\n- **[C] Xác nhận**: Chuyển sang định nghĩa contract.\n\nHALT và chờ người dùng chọn.\n- On **[C]**: Chuyển sang \`./step-02-contract-boundary-and-obligations.md\`.` },
      { file: 'step-02-contract-boundary-and-obligations.md', title: 'Định Nghĩa Contract Chi Tiết', next: 'step-03-artifact-checklist-and-handoff.md',
        content: `### 1. Per contract definition\n- Schema với types và nullable\n- Freshness SLA\n- Quality guarantees (null rate, uniqueness)\n- Breaking vs Compatible change policy\n- Notification process\n- Version: MAJOR.MINOR.PATCH\n\n### 2. HALT - Contract Level Approval\nCả producer và consumer phải đồng ý policy trước khi ký contract.\n\n- **[C] Đã đồng ý**: Chuyển sang soạn thảo.\n\nHALT và chờ người dùng chọn.\n- On **[C]**: Chuyển sang \`./step-03-artifact-checklist-and-handoff.md\`.` },
      { file: 'step-03-artifact-checklist-and-handoff.md', title: 'Soạn Thảo Contracts và Bàn Giao', next: null,
        content: `### 1. Nạp template\nĐọc: 12-data-contract-specification-template.md\n\n### 2. Soạn thảo artifact\nMỗi contract: schema, SLA, quality guarantees, version, owners.\n\n### 3. Ghi file và cập nhật trạng thái\nLưu vào 12-data-contract-specification.md. Update workflow status.\n\n### 4. Menu bàn giao\n- **[C] Hoàn thành**: Gợi ý \`des-transformation-design\`.\n- **[R] Soạn lại**: Quay lại step-01.` }
    ]
  },
  'des-transformation-design': {
    steps: [
      { file: 'step-01-context-and-readiness.md', title: 'Context and Readiness', next: 'step-02-transformation-logic-and-dependencies.md',
        content: `### 1. Nạp artifact đầu vào\nĐọc: Silver design (10), Gold design (11), Data contracts (12), DQ rules (14 nếu có).\n\n### 2. Xác định transformation scope\nQuyết định xem phase này sẽ bao gồm toàn bộ P1 transformations hay chỉ các transformation cần thiết bởi các data contract outputs.\n\n### 3. HALT - Readiness Check Failed\n- **[C] Xác nhận**: Chuyển sang định nghĩa transformation logic.\n\nHALT và chờ người dùng chọn.\n- On **[C]**: Chuyển sang \`./step-02-transformation-logic-and-dependencies.md\`.` },
      { file: 'step-02-transformation-logic-and-dependencies.md', title: 'Transformation Logic and Dependencies', next: 'step-03-artifact-checklist-and-handoff.md',
        content: `### 1. Định nghĩa logic chi tiết\n- Source & target mappings\n- Output grain\n- Business rules (Rule IDs)\n- Join rules & cardinality\n- Deduplication & survivorship logic\n- SCD/history strategy\n- Incremental processing & backfill strategy\n- Watermark keys\n- Late-arriving & corrected data policy\n- Error handling & validation expectations\n\n### 2. HALT checkpoints\nYêu cầu phê duyệt cho mỗi quyết định quan trọng.\n\n- **[C] Tiếp tục**: Chuyển sang soạn thảo.\n\nHALT và chờ người dùng chọn.\n- On **[C]**: Chuyển sang \`./step-03-artifact-checklist-and-handoff.md\`.` },
      { file: 'step-03-artifact-checklist-and-handoff.md', title: 'Artifact, Checklist, and Handoff', next: null,
        content: `### 1. Nạp template\nĐọc: 13-transformation-specification-template.md\n\n### 2. Soạn thảo artifact\nGhi file 13-transformation-specification.md với đầy đủ 28 phần theo template.\n\n### 3. Ghi file và cập nhật trạng thái\nUpdate des-workflow-status.md.\n\n### 4. Menu bàn giao\n- **[C] Hoàn thành**: Gợi ý \`des-data-quality\`.\n- **[R] Soạn lại**: Quay lại step-01.` }
    ]
  },
  'des-data-quality': {
    steps: [
      { file: 'step-01-context-and-readiness.md', title: 'Context and Readiness', next: 'step-02-quality-rules-and-gates.md',
      ...
      { file: 'step-02-quality-rules-and-gates.md', title: 'Quality Rules and Gates', next: 'step-03-artifact-checklist-and-handoff.md',
      ...
      { file: 'step-03-artifact-checklist-and-handoff.md', title: 'Artifact, Checklist, and Handoff', next: null,
        content: `### 1. Nạp template\nĐọc: 14-data-quality-specification-template.md\n\n### 2. Soạn thảo artifact\nGhi file 14-data-quality-specification.md với đầy đủ 27 phần theo template.\n\n### 3. HALT - Checklist Blocked\nChạy configured checklist. Nếu checklist blocked → stop và resolve blockers trước khi tiếp tục.\n\n### 4. Ghi file và cập nhật trạng thái\nUpdate des-workflow-status.md.\n\n### 5. Menu bàn giao\n- **[C] Hoàn thành**: Gợi ý \`des-orchestration-observability\`.\n- **[R] Soạn lại**: Quay lại step-02.` }
    ]
  },
  'des-orchestration-observability': {
    steps: [
      ...
      { file: 'step-02-draft-and-handoff.md', title: 'Soạn Thảo Orchestration Spec và Bàn Giao', next: null,
        content: `### 1. Nạp template\nĐọc: 15-orchestration-observability-specification-template.md\n\n### 2. Soạn thảo artifact\nDAG design, schedule, retry policy, alert routing, observability setup.\n\n### 3. Ghi file và cập nhật trạng thái\nLưu vào 15-orchestration-observability-specification.md. Update workflow status.\n\n### 4. Menu bàn giao\n- **[C] Hoàn thành**: Gợi ý \`des-semantic-model-design\`.\n- **[R] Soạn lại**: Quay lại step-01.` }
    ]
  },
  'des-semantic-model-design': {
    steps: [
      ...
      { file: 'step-02-draft-and-handoff.md', title: 'Soạn Thảo Semantic Model và Bàn Giao', next: null,
        content: `### 1. Nạp template\nĐọc: 16-semantic-model-specification-template.md\n\n### 2. Soạn thảo artifact\nMeasures, dimensions, relationships, RLS roles.\n\n### 3. Ghi file và cập nhật trạng thái\nLưu vào 16-semantic-model-specification.md. Update workflow status.\n\n### 4. Menu bàn giao\n- **[C] Hoàn thành**: Gợi ý \`des-serving-layer-design\`.\n- **[R] Soạn lại**: Quay lại step-01.` }
    ]
  },
  'des-serving-layer-design': {
    steps: [
      { file: 'step-01-context-and-readiness.md', title: 'Context and Readiness', next: 'step-02-serving-channels-and-consumer-experience.md',
        content: `### 1. Nạp artifact đầu vào\nĐọc: Gold design (11), Semantic model (16), Architecture (07), Data products (04).\n\n### 2. Xác nhận readiness\n- Semantic model đã có certified metrics chưa?\n- Consumer personas đã rõ ràng chưa?\n- Serving direction (API/Dashboard/Export/ML) đã được chốt trong architecture chưa?\n\n### 3. Menu tương tác\n- **[C] Tiếp tục**: Chuyển sang thiết kế serving channels.\n\nHALT và chờ người dùng chọn.\n- On **[C]**: Chuyển sang \`./step-02-serving-channels-and-consumer-experience.md\`.` },
      { file: 'step-02-serving-channels-and-consumer-experience.md', title: 'Serving Channels and Consumer Experience', next: 'step-03-artifact-checklist-and-handoff.md',
        content: `### 1. Thiết kế Serving Channel\n- Dashboards (Power BI, Tableau, Superset)\n- APIs (REST, GraphQL cho ứng dụng)\n- Data Sharing (Snowflake sharing, Delta sharing)\n- Reverse ETL (đồng bộ ngược về CRM/ERP)\n- AI/ML features (Feature store, vector DB)\n\n### 2. Trust và Access Control\n- Ai được xem cái gì? (RLS, CLS)\n- Trust signals: hiển thị freshness, DQ status cho người dùng.\n- Feedback loop: user báo lỗi dữ liệu ở đâu?\n\n### 3. Menu tương tác\n- **[C] Tiếp tục**: Xác nhận serving design, chuyển sang soạn thảo.\n\nHALT và chờ người dùng chọn.\n- On **[C]**: Chuyển sang \`./step-03-artifact-checklist-and-handoff.md\`.` },
      { file: 'step-03-artifact-checklist-and-handoff.md', title: 'Soạn Thảo Serving Layer Spec và Bàn Giao', next: null,
        content: `### 1. Nạp template\nĐọc: 17-serving-layer-specification-template.md\n\n### 2. Soạn thảo artifact\nServing channels, access model, trust signals, feedback loop.\n\n### 3. Ghi file và cập nhật trạng thái\nLưu vào 17-serving-layer-specification.md. Update workflow status.\n\n### 4. Menu bàn giao\n- **[C] Hoàn thành**: Gợi ý \`des-lineage-metadata-design\`.\n- **[R] Soạn lại**: Quay lại step-01.` }
    ]
  },
  'des-lineage-metadata-design': {
    steps: [
      ...
      { file: 'step-03-draft-and-handoff.md', title: 'Soạn Thảo Lineage & Metadata và Bàn Giao', next: null,
        content: `### 1. Nạp template\nĐọc: 18-lineage-metadata-specification-template.md\n\n### 2. Soạn thảo artifact\nLineage graph, column-level lineage, metadata catalog entries.\n\n### 3. Ghi file và cập nhật trạng thái\nLưu vào 18-lineage-metadata-specification.md. Update workflow status.\n\n### 4. Menu bàn giao\n- **[C] Hoàn thành**: Gợi ý \`des-governance-and-security\`.\n- **[R] Soạn lại**: Quay lại step-01.` }
    ]
  },
  ...
  'des-semantic-and-serving-layer': {
    steps: [
