...
const SKILL_MAP = [
  ...
  { name: 'des-architecture-design',           num: '07', tmpl: '07-architecture-design-template.md',           ckl: 'storage_design_checklist.md' },
  { name: 'des-ingestion-design',              num: '08', tmpl: '08-ingestion-design-template.md',              ckl: 'ingestion_pattern_checklist.md' },
  { name: 'des-bronze-layer-design',           num: '09', tmpl: '09-bronze-layer-design-template.md',           ckl: 'storage_design_checklist.md' },
  ...
  { name: 'des-data-contracts',               num: '12', tmpl: '12-data-contracts-template.md',               ckl: 'governance_checklist.md' },
  { name: 'des-transformation-design',        num: '13', tmpl: null,                                           ckl: 'transformation_design_checklist.md' },
  { name: 'des-data-quality',                 num: '14', tmpl: '14-data-quality-template.md',                 ckl: 'observability_checklist.md' },
  { name: 'des-orchestration-and-observability', num: '15', tmpl: '15-orchestration-and-observability-template.md', ckl: 'observability_checklist.md' },
  { name: 'des-semantic-model-design',        num: '16', tmpl: '16-semantic-model-design-template.md',        ckl: 'serving_checklist.md' },
  { name: 'des-serving-layer-design',         num: '17', tmpl: null,                                          ckl: 'serving_checklist.md' },
  { name: 'des-lineage-and-metadata',         num: '18', tmpl: '18-lineage-and-metadata-template.md',         ckl: 'governance_checklist.md' },
