...
- Thiếu đánh giá nguồn dữ liệu (Missing source assessment): Quy trình ingestion/architecture sẽ tự động chuyển hướng quay trở lại skill đánh giá nguồn dữ liệu (`de-data-source-assessment`).
