...
test("des-architecture-design uses generic Phase 7 artifact paths and step names", () => {
  ...
  assert.match(customize, /output_file = "\.agents\/des-skill\/output\/07-architecture-decision-record\.md"/);
  assert.match(customize, /template_file = "\.agents\/des-skill\/templates\/07-architecture-decision-record-template\.md"/);
  assert.match(customize, /checklist_file = "\.agents\/des-skill\/checklists\/07-architecture-design-checklist\.md"/);
