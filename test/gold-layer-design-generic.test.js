...
test("des-gold-layer-design uses generic Phase 11 artifact paths and step names", () => {
  ...
  assert.match(customize, /output_file = "\.agents\/des-skill\/output\/11-gold-layer-specification\.md"/);
  assert.match(customize, /template_file = "\.agents\/des-skill\/templates\/11-gold-layer-specification-template\.md"/);
  assert.match(customize, /checklist_file = "\.agents\/des-skill\/checklists\/11-gold-layer-design-checklist\.md"/);
