...
test("des-transformation-design uses generic Phase 13 artifact paths and step names", () => {
  ...
  assert.match(customize, /output_file = "_des-output\/planning-artifacts\/13-transformation-specification\.md"/);
  assert.match(customize, /template_file = "_des\/templates\/13-transformation-specification-template\.md"/);
  assert.match(customize, /checklist_file = "_des\/checklists\/13-transformation-design-checklist\.md"/);
  ...
  assert.match(customize, /_des-output\/planning-artifacts\/12-data-contract-specification\.md/);
});
