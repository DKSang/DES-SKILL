...
test("des-bronze-layer-design uses generic Phase 9 artifact paths and step names", () => {
  ...
  assert.match(customize, /output_file = "\.agents\/des-skill\/output\/09-bronze-layer-specification\.md"/);
  assert.match(customize, /template_file = "\.agents\/des-skill\/templates\/09-bronze-layer-specification-template\.md"/);
  assert.match(customize, /checklist_file = "\.agents\/des-skill\/checklists\/09-bronze-layer-design-checklist\.md"/);
