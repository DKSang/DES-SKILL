...
**Skill sử dụng**: `des-data-source-assessment`
**Input từ**: `03-requirements-and-kpi-catalog.md`
...
**Handoff**: Sau khi 2 câu hỏi trên được resolve → chuyển sang `des-domain-modeling`.
